...
class BaseAlgo(ABC):
    ...
    def __init__(self, envs, acmodel, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
        ...
        if self.use_subgoal:
            ...
            agent.initialize_mission(self.env.envs[0])
    ...
    def collect_experiences(self):
        ...
        for i in range(self.num_frames_per_proc):
            ...
            if self.use_subgoal:
                obs, reward, done, subgoals_consumed_steps = self.agent.apply_skill_batch(self.obs, self.env.envs, action)
                ...
                self.log_total_num_primitive_steps += subgoals_consumed_steps.sum()
